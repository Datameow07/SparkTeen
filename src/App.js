                        ...
                        <>
                            ...
                            <AnimatePresence mode="wait">
                                <Routes>
                                    ...
                                    <Route path="/wellness/meditation" element={<MeditationPage user={user} theme={theme} setTheme={setTheme} onLogout={handleLogout} />} />
                                    <Route path="/wellness/breathing" element={<BreathingPage user={user} theme={theme} setTheme={setTheme} onLogout={handleLogout} />} />
